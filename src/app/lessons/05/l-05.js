...
// 2. char = string in js
// 3. int = number in js
// 4. float = number in js
// 5. boolean
// 6. interface - not exists in js
// 7. undefined
console.log('05.02.2:');
var str = 'abc';
